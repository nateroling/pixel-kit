# https://gist.githubusercontent.com/eevee/26f547457522755cb1fb8739d0ea89a1/raw/33f1a98a21e8e852e49ee69d7f25db02b0a3b320/perlin.py
...
# https://www.delftstack.com/howto/python/python-dot-product/
def product(x, y, z):
...
class PerlinNoiseFactory(object):
    ...
    def _generate_gradient(self):
        ...
        random_point = [random.uniform(0, 1) for _ in range(self.dimension)]
